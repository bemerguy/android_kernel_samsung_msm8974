...
/* Tunables */
static const int sync_read_expire = HZ/5;	/* max time before a sync read is submitted. */
...
static const int async_reads_starved = 0;	/* max times sync reads can starve async reads */
