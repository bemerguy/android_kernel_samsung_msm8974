...
static const int sync_write_expire = HZ * 5;	/* max time before a sync write is submitted. */

static const int async_read_expire = HZ * 4;	/* ditto for async, these limits are SOFT! */
static const int async_write_expire = HZ * 7;	/* ditto for async, these limits are SOFT! */
